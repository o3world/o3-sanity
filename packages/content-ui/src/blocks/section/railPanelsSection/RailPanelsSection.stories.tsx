 ...
 * advance for free.
 *
 * Grab the columns — drag them, a sideways wheel, tab into the region and use
 * the arrow keys — and the page stops steering them for as long as the band is
 * on screen. Scroll the band clear of the viewport and back and it takes the
 * wheel again.
 *
