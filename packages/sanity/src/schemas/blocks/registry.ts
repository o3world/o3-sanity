 ...
 * that isn't listed here cannot be defined (the factories throw), and the
...
export const SECTION_BLOCKS = [
   ...
   * vocabulary rather than to a frame.
   */
  'statsSection',
] as const
...
export const BLOCK_ARRAYS = {
   ...
   */
  'collectionIndex.sectionsAbove': SECTION_BLOCKS,
  'collectionIndex.sectionsBelow': SECTION_BLOCKS,
  /**
...
/** Which arrays hold blocks and which blocks each holds. */
export type BlockArrays = typeof BLOCK_ARRAYS
