...
it exactly as written. Invoke the `o3-authoring` skill however this session
lists it — a plugin install surfaces it namespaced, as
`o3-authoring:o3-authoring` — and otherwise read
`tools/authoring-skill/skills/o3-authoring/SKILL.md` from the repo you are
