/* O3 Globe — Red (hero settings) — standalone. No dependencies.
   Renders the O3 wireframe atom/globe into #globe. Tweak CONFIG below.
   Values below are the live site's current tweak settings. */
(function () {
  var CONFIG = {
    // geometry / motion — matches the live hero atom
    scale: 1,              // 1 = true unit size (site hero blows it up to 2.5)
    tilt: 11,              // deg, rotateX
    angle: -17,            // deg, rotateZ
    lines: 7,              // orbit count
    lineWidth: 1.3,
    lineOpacity: 1.15,
    randomness: 0.2,
    speed: 0.3,
    seed: 1837,            // fixed seed = identical orbit layout every load
    mouseFollow: 0.8,      // 0 to disable
    ...
    // color
    glow: 1.4,             // outer red bloom
    accent: '#EB1000',
    accentDim: '#B03A2E',
    wire: '#E9EDF5',
    dotCols: ['#EB1000', '#B03A2E', '#C8C8CC', '#8A8A8E'],
    glowCols: ['#EB1000', '#7E140A', '#FF5A40'],
    shade: ['#EB1000', '#7E140A']
  };
