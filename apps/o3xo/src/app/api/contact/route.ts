 ...
 * validation, the spam checks and the payload — so this app and the O3 site
 * answer the same rules. What is this route's own is the page's name, the
 * visitor's address, and the status → HTTP mapping below.
 *
