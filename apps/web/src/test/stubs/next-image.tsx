...
export default function Image({ src, alt, width, height, sizes, className }: StubImageProps) {
  return (
    <img src={src} alt={alt} width={width} height={height} sizes={sizes} className={className} />
  )
}
