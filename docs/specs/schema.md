...
- **`layoutSection`** — the one true two-tier block: 1–3 columns of base blocks, plus `decoration` (`none | molecule`) — the Solutions proof-point band (`2357:2690`) hangs the molecule behind an ink layout band.
