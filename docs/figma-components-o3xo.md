...
| `Case Study Cards`       | `4404:3072`  | 6 client names (content) | `CaseStudyCard` (`apps/o3xo/src/content/documents/caseStudy/`) | ⚠️ **Diverges structurally** (#224). App-local (#245); the showcase band draws it through the card registry's per-app binding (#294) |
