...
| `/ventures`                      | **none**                  | migrate → provisional | `page-seed-ventures` — all copy carried from the WordPress page (wpId 155): header, the five partner criteria, REC Philly / Sahay AI / 1682 Venture Awards, and the closing callout. An ordinary standard page per CONTEXT.md. **No per-venture detail page exists in WordPress and none was invented**  | #23      |
