...
| `/contact`                                | `2960:7557` / `2975:10037` | transcribe → provisional | `page-seed-contact` — two bands: the interior hero, then a form card beside a rail carrying the Handler portrait, his quote and the studio's address (#331). The form carries Gravity Form 1's real field set but **it cannot send** — no handler, no destination — so the rail's email and phone are the only working path                                                                                                                                                                                                                                                                                                                                      | #48, #58, #331 |
...
| `page-seed-contact`                       | The form **cannot send** — #58 built the fields, not the mechanism or the destination                                               | #58's remaining halves: a handler with a spam story, and somewhere for a submission to land |
